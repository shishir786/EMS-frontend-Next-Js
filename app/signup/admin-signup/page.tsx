...
const AdminSignUp = () => {
  ...
  if (user) {
    if (Array.isArray(user.role)) {
      isAdmin = user.role[0]?.trim().toLowerCase() === "admin";
    } else if (typeof user.role === "string") {
      isAdmin = user.role.trim().toLowerCase() === "admin";
    }
  }
  if (!user || !isAdmin) {
    return <div className="text-center text-red-600 font-semibold mt-10">Access denied. Only admins can access this page.</div>;
  }
...
<Breadcrumb className="ml-5">
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbLink asChild>
              <Link href="/signup/admin-signup">add-people</Link>
            </BreadcrumbLink>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div>
        <h2 className="text-5xl font-bold text-center">Admin: Add User</h2>
        <form className="max-w-md mx-auto pt-5 mt-5" onSubmit={handleSubmit}>
          ...
          <div className="relative z-0 w-full mb-5 group">
            ...
            <select id="role" name="role" value={role} onChange={e => setRole(e.target.value)} className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
